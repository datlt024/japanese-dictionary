...
type VocabularyInsert = TablesInsert<"vocabularies">
type VocabularyWritingInsert = TablesInsert<"vocabulary_writings">
type VocabularyReadingInsert = TablesInsert<"vocabulary_readings">
type VocabularySenseInsert = TablesInsert<"vocabulary_senses">
...
async function reimportJmdictNormalized() {
    ...
    for (const [chunkIndex, chunk] of chunks.entries()) {
        const vocabularyRows: VocabularyInsert[] = chunk.map(
            (item) => ({
                jmdict_id: item.id,
