...
<p style="margin:0 0 10px;">　しかし、最近は少しずつですが、子供を頂かってくれる音楽会場や美術館、映画館などが増えてきました。また、<u>②親子が楽しめるように工夫をする</u>ところも出てきています。例えば、ある映画館では、映画の間も会場を少し明るくしておくそうです。暗いと、怖がって泣いてしまう子供がいるからです。大きな音を聞くと、びっくりする子供もいるので、音も大きすぎないようにしてあります。</p>
...
<p style="font-size:13px;margin:0 0 6px;">●最大の人数は、各食堂・カフェの席の数と同です。</p>
...
const _RAW: Omit<StaticQuestion, "explanation">[] = [
  ...
  { groupId: "q12", sectionId: "grammar", type: "grammar_blank", display: "38",
    context: PASSAGE_R7,
    sentence: "丸川大学の学生のオウさんは、10月23日（土）に②の食堂でクラスのパーティーを開きたいと考えている。10月23日に②の食堂かパーティーに利用できることは確認できたが、そのほかに気をつけなければならないこととして、合っているのはどれか。",
    options: [
      "学生が申し込みをすることはできない。",
